            ...
            <div class="login-container">
                <div class="form-container">
                    <form action="/process/edit/profile" method="POST">
                        @csrf
                        <label>Nama</label><br>
                        <input type="text" required name="name" class="input-box shadow-sm"><br>
                        <label>Pilih Sekolah</label><br>
                        <select name="school_id" class="input-box">
                            @foreach($schools->original as $key => $value)
                                <option value="{{$value["id"]}}">{{$value["name"]}}</option>
                            @endforeach
                        </select><br>
                        <input type="submit" name="edit" value="Simpan Perubahan" class="input-btn btn" id="btn-login">
                    </form>
                </div>
            </div>
        </div>
